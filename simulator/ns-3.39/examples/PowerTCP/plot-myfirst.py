...
results="./results_myfirst/"
plots_dir="./plot_myfirst/"
...
for alg in algs:
    ...
    ax1=ax.twinx()
    ax.set_yticks([100e9,420e9])
    ax.set_yticklabels(["Packet","Optical"])
    ax.set_ylabel("Throughput (Gbps)")

    start=0.13
    xtics=[i*0.01+start for i in range(0,8)]
    ax.set_xticks(xtics)
    xticklabels=[str(i*10) for i in range(0,8)]
