...
uint64_t optical_reconfigure_delay;
uint64_t optical_oswitch_rate;
...
int main(int argc, char* argv[])
{
	...
	std::string confFile = "/home/lbb/OpticalSimulation/simulator/ns-3.39/examples/PowerTCP/config-first.txt";
	std::cout << confFile;
	CommandLine cmd;
	...
	Simulator::Schedule(Seconds(delay), PrintResults, switchDown, 4, delay);
